	...
	<div class="wrapper bgd-image">
		<div class="container">
			<div class="container__left">
				<Illustrations name="doctor-patient-1" class="illustration" />
				<div class="text-content">
					<h2 class="heading">Enjoy medical services from your comfort zone</h2>
					<p class="copy">
			...
			<div class="container__right">
				...
				>
					<div class="form__header">
						...
						<p class="fs-14 fw-regular lh-125">as a patient</p>
					</div>
					<div v-scrollViz class="form__body">
						...
						<div class="form__inputs">
							...
							<div class="input__group">
								...
								>
									<slot v-if="v$.userDetails.date_of_birth.$error">
										<p class="error-input">
											{{ v$.userDetails.date_of_birth.$errors[0].$message }}
										</p>
									</slot>
								</DatePicker>
							</div>
						...
						<div class="link-group">
							...
							<p class="caption">
								Not a patient?
								<router-link :to="{ name: 'Signup-specialist' }" class="text-link">
	...
	validations() {
		return {
			userDetails: {
				...
				date_of_birth: {
					required: helpers.withMessage("This field is required", required),
					minimumAge: helpers.withMessage("You have to be at least 18", minimumAge),
					$autoDirty: true,
				},
				password: {
	...
	methods: {
		...
		async appleSignIn(userType) {
			AppleID.auth.init({
				...
				scope: "name email",
				redirectURI: window.location.origin + "/signup/patient",
				state: `${userType}`,
				usePopup: true,
			});
