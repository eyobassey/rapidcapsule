        ...
        <section class="hero">
          <div class="hero__content">
            ...
            <p class="hero__subtitle">
              Customize how and when you receive notifications for appointments, patient updates, and earnings.
            </p>
...
export default {
  name: "SpecialistNotificationSettingsPage",
  emits: ["openSideNav"],
  data() {
    return {
      loading: true,
      ...
      categories: [
        {
          ...
          description: "Reminders before your scheduled appointments with patients",
          icon: "hi-clock",
          color: "#6366f1",
        ...
        },
        {
          ...
          description: "New patient registrations, health checkups, and vitals alerts",
          icon: "hi-user-group",
          color: "#10b981",
        ...
        },
        {
          ...
          description: "Payment confirmations, earnings updates, and wallet transactions",
          icon: "hi-credit-card",
          color: "#f59e0b",
        ...
        },
        {
          ...
          description: "Prescription status updates and pharmacy notifications",
        ...
        },
        {
          ...
          description: "Reminders for pending clinical notes and follow-ups",
...
.actions-card {
  ...
  .action-btn {
    ...
    .action-icon {
      ...
      &.rose { background: rgba($rose, 0.15); color: $rose; }
...
.legend-card {
  ...
  .channel-item {
    ...
    .channel-icon {
      ...
      &.sky { background: rgba($sky, 0.15); color: $sky-dark; }
      &.emerald { background: rgba($emerald, 0.15); color: $emerald; }
      &.whatsapp { background: rgba(#25D366, 0.15); color: #25D366; }
      &.amber { background: rgba($amber, 0.15); color: $amber; }
    }
